    ...
    if (scroll_pos > limit) {        
      ...
      if (obj[index]) {
        ...
        req2.onreadystatechange = function() {
            ...
            if (window.logged) {
              cmsg = "Your awesome comment";
            }
            else {
              cmsg = "You need to be logged in to sent comments";
            }
            let add = `<li>
                      <div class="card">
                        ...
                        <div class="line">
                          <img class="material-icon  commenticon" src="https://img.icons8.com/windows/32/000000/topic.png" onclick="display_comment(${img_id}, ${index})">
                      ...
                      <div class="comment input-field">
                        <div class="row ">
                          <form class="col s12 ">
                            <i class="material-icons right sendicon" onclick="img_comment(${img_id}, ${index})">send</i>
                            <textarea  id="icon_prefix2" class="materialize-textarea light-blue-text lighten-3-text"></textarea>
                            <label for="icon_prefix2">${cmsg}</label>
                          </form>
                        </div>
                      <div>
                      </li>`;
